            ...
            <div class="lg:col-span-2 flex flex-col gap-6">
                ...
                <div class="relative rounded-3xl overflow-hidden bg-gray-900 shadow-xl aspect-video">
                    <video id="mainVideo"
                        ...
                        <source src="{{ asset('storage/' . $firstContent->isi_konten) }}" type="video/mp4">
                    ...
                    <div id="videoOverlay"
                        ...
                        <div class="w-16 h-16 rounded-full bg-white/90 flex items-center justify-center
                            ...
                            <svg class="w-7 h-7 text-[#033E8A] ml-1" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent px-4 pb-3 pt-6">
                        <div class="flex items-center gap-3">
                            <button onclick="togglePlay()" class="text-white hover:text-gray-300 transition-colors">
                                <svg id="playIcon" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z"/> {{-- pause icon --}}
                                </svg>
                            </button>
                            <div class="flex-1 relative h-1 bg-white/30 rounded-full cursor-pointer" id="progressBar" onclick="seekVideo(event)">
                                <div id="videoProgress" class="h-full bg-[#0AADA8] rounded-full" style="width:0%"></div>
                            </div>
                            <span id="videoTime" class="text-white text-xs font-montserrat">0:00 / 0:00</span>
                            <button onclick="toggleMute()" class="text-white hover:text-gray-300 transition-colors">
                ...
                <div class="rounded-3xl overflow-hidden shadow-xl">
                    <img src="{{ asset('storage/' . $firstContent->isi_konten) }}"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <button class="flex items-center justify-center gap-2 border border-gray-200 rounded-2xl py-3.5
            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-5">
                    ...
                    <div class="flex items-center justify-between text-sm font-montserrat mb-2">
                        <span class="text-[#033E8A] font-semibold">{{ $progress?->persentase_progress ?? 0 }}% Selesai</span>
                ...
                <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-5">
                    ...
                    <div class="flex items-start justify-between py-3 border-b border-gray-50">
                        <div class="flex-1 mr-3">
                            ...
                            <p class="font-montserrat text-gray-400 text-xs mt-0.5">Tampilkan notifikasi lembut untuk jeda setiap 15 menit.</p>
                        </div>
                    ...
                    <div class="flex items-start justify-between py-3">
                        <div class="flex-1 mr-3">
                            ...
                            <p class="font-montserrat text-gray-400 text-xs mt-0.5">Sembunyikan elemen visual yang tidak penting.</p>
                        </div>
                        <label class="relative inline-flex items-center cursor-pointer mt-1">
